...
shared_context "swt app" do
  ...
  let(:swt_app) { double('swt app', real: swt_app_real, disposed?: false, add_paint_listener: true) }
  let(:shoes_app) { double('shoes app', gui: swt_app, unslotted_elements: []) }#.as_null_object }
