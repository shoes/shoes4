    ...
    module Common
      ...
      module Fill
        ...
        def apply_fill(context)
          if fill
            l, t = self.is_a?(Star) ? [element_left-width/2.0, element_top-height/2.0] : [element_left, element_top]
            fill.apply_as_fill(context, l, t, element_width, element_height, angle)
            true
          end
        end
      end
